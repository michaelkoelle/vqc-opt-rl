...
sns.set_theme(font_scale=1.1, style="whitegrid", palette="colorblind")  # anpassen
...
alpha = 0.3
labels = [
    "QPPO-Critic-Lr(0.5e-4)",
    "QPPO-Critic-Lr(2.5e-4)",
    "QPPO-Critic-Lr(5.0e-4)",
    "QPPO-Critic-Lr(10.0e-4)",
    "Zufällige Aktionsauswahl",
]
...
alpha = 0.3
labels = [
    "Lr=(10->0.1)e-3, HWZ=15000",
    "Lr=(10->0.1)e-3, HWZ=25000",
    "Lr=(10->0.1)e-3, HWZ=40000",
    "Lr=(10->1.0)e-3, HWZ=10000",
    "Lr=(10->1.0)e-3, HWZ=20000",
    "Lr=(10->1.0)e-3, HWZ=35000",
    "Zufällige Aktionsauswahl",
    "Konst-Lr=2.5e-3",
]
...
alpha = 0.3
labels = [
    "globalesOutScale(1e-3) (73-Param)",
    "globalesOutScale(1e-2) (73-Param)",
    "LokalesOutScale(1e-3) (76-Param)",
    "LokalesOutScale(1e-2) (76-Param)",
    "LokalesOutScale(5e-2) (76-Param)",
    "Zufällige Aktionsauswahl",
    "keinOutScale (72-Param)",
]
...
alpha = 0.3
labels = [
    "QPPO global out-scale(1e-2) (73)",
    "QPPO local out-scale(1e-2) (76)",
    "QPPO local out-scale(5e-2) (76)",
    # "PPO (67)",
    "PPO (88)",
    "Random",
]
...
alpha = 0.3
labels = [
    "globalesOutScale(1e-4)",
    "globalesOutScale(1e-3)",
    "globalesOutScale(1e-2)",
    "globalesOutScale(5e-2)",
    "globalesOutScale(1e-1)",
    "Zufällige Aktionsauswahl",
]
...
alpha = 0.3
labels = [
    "LokalesOutScale(1e-4)",
    "LokalesOutScale(1e-3)",
    "LokalesOutScale(1e-2)",
    "LokalesOutScale(5e-2)",
    "LokalesOutScale(1e-1)",
    "Zufällige Aktionsauswahl",
]
...
alpha = 0.3
labels = [
    "QPPO-globalesOutScale(1e-2)-(73-Param)",
    "QPPO-lokalesOutScale(1e-2)-(76-Param)",
    "QPPO-lokalesOutScale(5e-2)-(76-Param)",
    "PPO(4,4)-Lr(1.0e-2)-(108-Param)",
]
plot_test_avg_final(results_dir, plot_dir, gym_id, exp_names, seeds, alpha, max_steps, labels)
...
alpha = 0.3
labels = [
    "QPPO re-uploading(5e-3)",
    "QPPO re-uploading(1e-3)",
    "QPPO (5e-3)",
    "QPPO (1e-3)",
    "Random",
]
...
labels = [
    "QPPO all (73)",
    "QPPO w/o re-uploading (73)",
    "QPPO w/o out-scale (72)",
    "QPPO w/o exp-lr (73)",
    # "PPO (67)",
    "PPO (88)",
    "Random",
...
alpha = 0.05
labels = [
    "NN(5,5)-Sigmoid-Lr-(67-Param)",
    "NN(6,5)-Sigmoid-Lr-(77-Param)",
    "NN(6,6)-Sigmoid-Lr-(86-Param)",
    "NN(7,7)-Sigmoid-Lr-(107-Param)",
    "NN(64,64)-Sigmoid-Lr-(4610-Param)",
    "Zufällige Aktionsauswahl",
]
...
labels = [
    "QPPO Lr=2.5e-3",
    "QPPO Lr=1.0e-2",
    "QPPO Lr=(10->0.1)e-3, HWZ=15000",
    "QPPO Lr=(10->0.1)e-3, HWZ=25000",
    "QPPO Lr=(10->0.1)e-3, HWZ=35000",
    "Zufällige Aktionsauswahl",
    "PPO(5,5) Lr=1.0e-4",
]
...
alpha = 0.05
labels = [
    "QPPO-Lr(2.5e-3)-OutScale(1e-4)-Zirkuläre-LV",
    "QPPO-Lr(2.5e-3)-OutScale(1e-3)-Zirkuläre-LV",
    "QPPO-Lr(5.0e-3)-OutScale(1e-3)-Zirkuläre-LV",
    "QPPO-Lr(2.5e-3)-OutScale(1e-4)",
    "QPPO-Lr(2.5e-3)-OutScale(1e-3)",
    "QPPO-Lr(5.0e-3)-OutScale(1e-3)",
    "Zufällige Aktionsauswahl",
]
...
max_steps = 500000
alpha = 0.05
labels = ["Standard init", "Clipped gaussian init", "Small init", "Random"]
...
labels = [
    ...
    "lr=2.5e-3",
    "lr=10e-3",
    "Exp-lr=($10\\rightarrow0.1$)e-3, HL= 75000",
    "Exp-lr=($2.5\\rightarrow0.1$)e-3, HL=100000",
    "Exp-lr=($2.5\\rightarrow0.1$)e-3, HL=150000",
    "Random",
]
...
alpha = 0.05
labels = [
    "pi*tanh(x)-Reskalierung",
    "pi*tanh(2x)-Reskalierung",
    "2pi*arctan(x)-Reskalierung",
    "2pi*arctan(2x)-Reskalierung",
    "Zufällige Aktionsauswahl",
]
...
labels = [
    "QPPO man-scale (73)",
    "QPPO global in-scale (77)",
    "QPPO (5-layer) in-scale (81)",
    # "PPO(5,5)-(67-Param)",
    # "PPO(6,5)-(77-Param)",
    "PPO (86)",
    "Random",
...
labels = [
    "QPPO man-scale (73)",
    "QPPO glob-in-scale (77)",
    "QPPO (4-layer) in-scale (65)",
    "QPPO (5-layer) in-scale (81)",
    # "PPO(5,5)-(67-Param)",
    "PPO (77)",
    "Random",
